...
if [ $TRAVIS_REPO_SLUG == "tomcat-slf4j-logback/tomcat-slf4j-logback-parent" ] && [ $TRAVIS_PULL_REQUEST == "false" ] && [ $TRAVIS_BRANCH == "master" ] && [[ "$commit_message" != *"[maven-release-plugin]"* ]]; then
